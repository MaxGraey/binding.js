...
(function (global) {
    ...
    /** @private */
    function _emptyProperties(properties) {
    ...
    function _bindProperties(object, properties, callback) {
        if (_emptyProperties(properties)) {
    ...
    function htmlElementBinding(object, properties, callback, options) {
        ...
        _observers.set(object, observer);
    }
    ...
    Binding.on = function (object, properties, callback, options) {
        ...
        if (typeof properties === 'string') {
            if (_spacesExpr.test(properties)) {
                _bindProperties(object, properties.split(_spacesExpr), callback);
            } else {
    ...
    Binding.off = function (object, properties) {
        ...
        if (isHtmlElement(object)) {
            _observers.get(object).disconnect();
            ...
            if (typeof properties === 'string') {
                if (_spacesExpr.test(properties)) {
                    _unbindProperties(object, properties.split(_spacesExpr));
                } else {
                    var property = properties;
